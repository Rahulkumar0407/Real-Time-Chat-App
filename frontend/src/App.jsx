...
export default function App() {
    ...
    function sendMessage() {
        ...
        // DO NOT add the message locally. Let the server send it back.
        // setMessages((m) => [...m, msg]); <--- THIS LINE IS REMOVED
    ...
    let typingDisplay = '';
    if (typers.length > 0) {
        if (typers.length === 1) typingDisplay = `${typers[0]} is typing...`;
        else if (typers.length === 2) typingDisplay = `${typers[0]} and ${typers[1]} are typing...`;
        else typingDisplay = 'Several people are typing...';
    }
            ...
            {showNamePopup && (
                <div className="fixed inset-0 flex items-center justify-center z-40">
                    <div className="bg-white rounded-xl shadow-lg max-w-md p-6 w-full">
                        <h1 className="text-2xl font-bold text-center text-black">Gup Shup App</h1>
                        <p className="text-sm text-gray-500 mt-2 text-center">Enter your name to start chatting.</p>
                ...
                <div className="w-full max-w-2xl h-[90vh] bg-white rounded-xl shadow-md flex flex-col overflow-hidden">
                    <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500 h-4">{typingDisplay}</div>
                        </div>
